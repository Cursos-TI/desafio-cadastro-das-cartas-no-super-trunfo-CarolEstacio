 ...
 int Turistico1, Populacao1;    // declara tipos de dados inteiros. 
 float KM1, Pib1, Densidade1, PibPerc1;   // declara tipos de dados flutuantes. 

 // variáveis e tipos de dados da carta n2:

 char Estado2 [30], Cidade2 [30], Codigo2 [30]; // Declara três arrays, cada um de 30 caracteres. 
 int Turistico2, Populacao2;    // declara tipos de dados inteiros. 
 float KM2, Pib2, Densidade2, PibPerc2;    // declara tipos de dados flutuantes. 
 ...
 printf("O nome da cidade é: %s\n", Cidade2);
 printf("A população é de:%d\n", Populacao2);
 printf("A área em km² é:%.3f hab/km \n", KM2);
 printf("O Pib é de:%.6f\n", Pib2);
 printf("Os números de pontos túristicos são:%d\n", Turistico2);
 printf("A densidade Populacional é de: %.6f\n", Densidade2);
 printf(" O Pib Per Capta é de:%.6f\n", PibPerc2);
